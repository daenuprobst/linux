...
## CachyOS (Niri)
```bash
pacman -Syy kitty zen-browser-bin rust go neovim starship lsd zoxide yazi python-black uv pyright ruff fx xan btop glow marksman chezmoi yay zotero ttf-firacode-nerd cmake grim slurp satty papirus-icon-theme network-manager-applet nwg-look qpdf greetd-tuigreet imv
